...
@interface PEAppController : NSObject <FFErrorReportingProtocol, NSApplicationDelegate, NSUserInterfaceValidations, NSMenuDelegate, PEFullScreenWindowDelegate>
{
...
- (void)toggleWaveform:(id)arg1;
- (void)toggleVectorscope:(id)arg1;
- (BOOL)scopesVisible;
- (BOOL)waveformVisible;
- (BOOL)vectorscopeVisible;
- (void)toggleColorBoardWithActivation:(id)arg1;
