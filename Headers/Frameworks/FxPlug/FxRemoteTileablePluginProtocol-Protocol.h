...
@class FxImageTile, FxRemoteOSCData, FxRemoteTiming, NSArray, NSData, NSDictionary, NSMutableArray, NSString, NSViewController;
...
- (void)pluginSession:(unsigned long long)arg1 startAnalysisForRange:(CDStruct_5c5366e1)arg2 sampleDuration:(CDStruct_1b6d18a9)arg3 reply:(void (^)(BOOL, NSError *))arg4;
- (void)pluginSession:(unsigned long long)arg1 desiredAnalysisTimeRange:(CDStruct_5c5366e1)arg2 timingData:(FxRemoteTiming *)arg3 reply:(void (^)(BOOL, struct, NSError *))arg4;
...
- (void)setupAnalysisConnection:(unsigned long long)arg1 reply:(void (^)(NSError *))arg2;
...
- (void)OSCPlugin:(unsigned long long)arg1 mouseExitedAtPosition:(struct CGPoint)arg2 modifiers:(unsigned long long)arg3 oscData:(FxRemoteOSCData *)arg4 parameters:(NSArray *)arg5 atTime:(CDStruct_1b6d18a9)arg6 transactionID:(unsigned long long)arg7 reply:(void (^)(BOOL, BOOL, NSError *))arg8;
...
- (void)OSCPlugin:(unsigned long long)arg1 mouseEnteredAtPosition:(struct CGPoint)arg2 modifiers:(unsigned long long)arg3 oscData:(FxRemoteOSCData *)arg4 parameters:(NSArray *)arg5 atTime:(CDStruct_1b6d18a9)arg6 transactionID:(unsigned long long)arg7 reply:(void (^)(BOOL, BOOL, NSError *))arg8;
...
- (void)OSCPlugin:(unsigned long long)arg1 mouseMovedAtPosition:(struct CGPoint)arg2 activePart:(long long)arg3 modifiers:(unsigned long long)arg4 oscData:(FxRemoteOSCData *)arg5 parameters:(NSArray *)arg6 atTime:(CDStruct_1b6d18a9)arg7 transactionID:(unsigned long long)arg8 reply:(void (^)(BOOL, BOOL, NSError *))arg9;
...
- (void)OSCPlugin:(unsigned long long)arg1 mouseUpAtPosition:(struct CGPoint)arg2 activePart:(long long)arg3 modifiers:(unsigned long long)arg4 oscData:(FxRemoteOSCData *)arg5 parameters:(NSArray *)arg6 atTime:(CDStruct_1b6d18a9)arg7 transactionID:(unsigned long long)arg8 reply:(void (^)(BOOL, BOOL, NSError *, NSArray *))arg9;
...
- (void)OSCPlugin:(unsigned long long)arg1 mouseDraggedAtPosition:(struct CGPoint)arg2 activePart:(long long)arg3 modifiers:(unsigned long long)arg4 oscData:(FxRemoteOSCData *)arg5 parameters:(NSArray *)arg6 atTime:(CDStruct_1b6d18a9)arg7 transactionID:(unsigned long long)arg8 reply:(void (^)(BOOL, BOOL, NSError *, NSArray *))arg9;
...
- (void)OSCPlugin:(unsigned long long)arg1 mouseDownAtPosition:(struct CGPoint)arg2 activePart:(long long)arg3 modifiers:(unsigned long long)arg4 oscData:(FxRemoteOSCData *)arg5 parameters:(NSArray *)arg6 atTime:(CDStruct_1b6d18a9)arg7 transactionID:(unsigned long long)arg8 reply:(void (^)(BOOL, BOOL, NSError *, NSArray *))arg9;
...
- (void)OSCPlugin:(unsigned long long)arg1 keyUpAtPosition:(struct CGPoint)arg2 keyPressed:(unsigned short)arg3 modifiers:(unsigned long long)arg4 oscData:(FxRemoteOSCData *)arg5 parameters:(NSArray *)arg6 atTime:(CDStruct_1b6d18a9)arg7 transactionID:(unsigned long long)arg8 reply:(void (^)(BOOL, BOOL, BOOL, NSError *, NSArray *))arg9;
...
- (void)OSCPlugin:(unsigned long long)arg1 keyDownAtPosition:(struct CGPoint)arg2 keyPressed:(unsigned short)arg3 modifiers:(unsigned long long)arg4 oscData:(FxRemoteOSCData *)arg5 parameters:(NSArray *)arg6 atTime:(CDStruct_1b6d18a9)arg7 transactionID:(unsigned long long)arg8 reply:(void (^)(BOOL, BOOL, BOOL, NSError *, NSArray *))arg9;
...
- (void)OSCPlugin:(unsigned long long)arg1 hitTestAtPosition:(struct CGPoint)arg2 oscData:(FxRemoteOSCData *)arg3 parameters:(NSArray *)arg4 atTime:(CDStruct_1b6d18a9)arg5 transactionID:(unsigned long long)arg6 reply:(void (^)(BOOL, long long, NSError *))arg7;
...
- (void)OSCPlugin:(unsigned long long)arg1 drawWithWidth:(long long)arg2 height:(long long)arg3 activePart:(long long)arg4 destinationImage:(FxImageTile *)arg5 oscData:(FxRemoteOSCData *)arg6 parameters:(NSArray *)arg7 atTime:(CDStruct_1b6d18a9)arg8 transactionID:(unsigned long long)arg9 reply:(void (^)(BOOL, NSError *))arg10;
...
- (void)getPluginState:(unsigned long long)arg1 atTime:(CDStruct_1b6d18a9)arg2 transactionID:(unsigned long long)arg3 quality:(unsigned long long)arg4 withParameters:(NSArray *)arg5 timingData:(FxRemoteTiming *)arg6 threeDData:(NSData *)arg7 lightingData:(NSData *)arg8 pathData:(NSMutableArray *)arg9 colorData:(NSData *)arg10 withReply:(void (^)(BOOL, NSData *, NSError *))arg11;
...
- (void)tileablePluginAddedToDocument:(unsigned long long)arg1 timingData:(FxRemoteTiming *)arg2;
