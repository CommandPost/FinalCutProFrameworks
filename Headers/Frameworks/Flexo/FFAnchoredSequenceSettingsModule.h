...
@class FFProject, NSInvocation, NSMatrix, NSPopUpButton, NSString, NSTextField, NSView;

@interface FFAnchoredSequenceSettingsModule : FFSettingsModule
{
    ...
    NSMatrix *timecodeDisplayModeMatrix;
...
+ (void)updateDefaultSettingsDisplayFormat:(id)arg1 displaySize:(id)arg2 displayRate:(id)arg3 timecodeDisplayDropFrame:(BOOL)arg4 renderFormat:(id)arg5 audioSampleRate:(unsigned long long)arg6 audioChannelCount:(unsigned long long)arg7 videoSetPropertyManually:(BOOL)arg8 audioSetPropertyManually:(BOOL)arg9;
- (void)dealloc;
