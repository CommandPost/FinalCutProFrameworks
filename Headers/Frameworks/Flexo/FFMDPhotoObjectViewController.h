...
- (void)clearPlayer;
- (void)imageBrowser:(id)arg1 displayMediaInViewer:(id)arg2 context:(id)arg3 effectCount:(long long)arg4 loadingBlock:(CDUnknownBlockType)arg5 unloadingBlock:(CDUnknownBlockType)arg6;
- (BOOL)imageBrowser:(id)arg1 isSkimmingInViewerWithSkimmable:(id)arg2;
- (void)resetSkimmingDelay;
- (void)imageBrowser:(id)arg1 mouseExited:(id)arg2;
- (void)imageBrowserStopSkimmingInViewer:(id)arg1;
- (BOOL)imageBrowser:(id)arg1 startSkimmingInViewerWithSkimmable:(id)arg2 context:(id)arg3 effectCount:(long long)arg4;
- (id)imageBrowser:(id)arg1 skimmingMediaForCell:(id)arg2;
