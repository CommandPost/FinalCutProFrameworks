...
#import <Flexo/FFMaskBaseMatteScreenable-Protocol.h>
...
- (void)_setHSLQualifierNode:(HGRef_265f9e4c *)arg1 preMaskNode:(struct HGNode *)arg2 atTime:(const CDStruct_1b6d18a9 *)arg3;
- (BOOL)_setNuvoKeyer:(HGRef_265f9e4c *)arg1 preMaskNode:(struct HGNode *)arg2 atTime:(const CDStruct_1b6d18a9 *)arg3;
