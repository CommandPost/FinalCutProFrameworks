...
#import <Flexo/FFMediaSidebarOutlineViewDelegate-Protocol.h>
...
@interface FFMediaSidebarController : NSObject <NSOutlineViewDataSource, FFMediaSidebarOutlineViewDelegate>
{
    ...
    int _silenceSelectionChangeCounter;
...
@property(nonatomic) int silenceSelectionChangeCounter; // @synthesize silenceSelectionChangeCounter=_silenceSelectionChangeCounter;
...
- (BOOL)silenceSelectionChange;
- (void)endSilencingSelectionChange;
- (void)startSilencingSelectionChange;
