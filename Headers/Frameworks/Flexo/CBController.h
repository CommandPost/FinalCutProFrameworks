...
- (id)layerNameForTabItem:(int)arg1;
...
- (id)layerNameForBoardType:(int)arg1;
...
- (id)layerNameForPuckType:(int)arg1 boardType:(int)arg2;
- (id)imageForPuckType:(int)arg1 boardType:(int)arg2;
- (id)pressedImageForPuckType:(int)arg1 boardType:(int)arg2;
- (double)puckInfoLayerLeftInsetForPuckType:(int)arg1 boardType:(int)arg2;
- (double)puckInfoLayerRightInsetForPuckType:(int)arg1 boardType:(int)arg2;
