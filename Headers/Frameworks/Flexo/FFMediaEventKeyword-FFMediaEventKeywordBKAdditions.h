...
#import <Flexo/FFMediaEventKeyword.h>
...
@interface FFMediaEventKeyword (FFMediaEventKeywordBKAdditions) <FFOrganizerMasterItem, FFOrganizerItemDraggingSource, FFOrganizerMasterItemDropTarget>
