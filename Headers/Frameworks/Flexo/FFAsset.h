...
@class FFCustomCameraLUTProps, FFDominantMotionMediaRep, FFFlowMediaRep, FFMediaRep, FFVideoProps, NSArray, NSDictionary, NSSet, NSString;
...
- (id)videoOverrides;
- (id)_videoOverridesIfAlreadyCached;
- (void)_resetVideoOverrides:(id)arg1;
