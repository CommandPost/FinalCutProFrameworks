...
@class FFAnchoredObject, FFAnchoredSequence, FFAnchoredTimeMarker, FFContext, FFNUpDisplay, FFNumericEntry, FFPasteboard, FFRenderStateTracker, FFShareHelper, FFSnappingCalculation, FFTimelineToolController, FFVideoFormat, NSArray, NSMenu, NSMenuItem, NSMutableDictionary, NSPasteboard, NSString, TLKTimelineView;
...
@property(readonly) FFContext *selectionContext; // @synthesize selectionContext=_selectionContext;
...
- (BOOL)_actionReplaceItem:(id)arg1 withItemsOnPasteboard:(id)arg2 performUIAction:(BOOL)arg3 replaceActionType:(int)arg4 editsAdded:(id *)arg5 trackType:(id)arg6;
...
- (void)createReferencedClipSheetClosing:(int)arg1 sequence:(id)arg2 project:(id)arg3;
...
- (BOOL)bladeAllCore:(BOOL)arg1 bladeAll:(BOOL)arg2;
- (void)cut:(id)arg1;
- (void)copy:(id)arg1;
...
- (BOOL)_shouldTrimClipToMoveEdge:(int)arg1 ofRangeItem:(id)arg2 toTime:(CDStruct_1b6d18a9 *)arg3;
- (void)setDisableAudio:(BOOL)arg1 forRange:(CDStruct_e83c9415)arg2 ofAudioComponent:(id)arg3;
- (void)_fixOuterKeyframesForAudioComponent:(id)arg1;
...
- (void)timelineView:(id)arg1 addChapterPinToMarker:(id)arg2 inLayer:(id)arg3;
- (int)timelineView:(id)arg1 visibilityForItem:(id)arg2;
- (void)timelineView:(id)arg1 didDoubleClickAudioWaveformOfItem:(id)arg2;
...
- (id)timelineView:(id)arg1 insertCopiesOfItems:(id)arg2 clickedItem:(id *)arg3;
- (id)_anchorStorylineItems:(id)arg1 container:(id)arg2;
- (id)_insertCopiesOfItemsAsAnchors:(id)arg1 clickedItem:(id *)arg2;
- (id)_insertCopiesOfItems:(id)arg1 clickedItem:(id *)arg2 container:(id)arg3;
...
- (void)timelineView:(id)arg1 resolveVerticalOrderAfterTrimForItems:(id)arg2;
