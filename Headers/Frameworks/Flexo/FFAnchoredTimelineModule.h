...
@interface FFAnchoredTimelineModule : FFEditorModule <FFSequenceEditingActions, FFSharableContent, FFControllerProtocol, FFNumericEntrySource>
{
...
- (CDStruct_1b6d18a9)_conformTimescale:(CDStruct_1b6d18a9)arg1;
