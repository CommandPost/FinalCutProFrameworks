...
- (void)trimEdge:(id)arg1 edgeType:(int)arg2 ofEdits:(id)arg3 byTimeOffset:(CDStruct_1b6d18a9 *)arg4 withCommand:(int)arg5;
...
- (void)timelineView:(id)arg1 precisionEditorWillSkimItem:(id)arg2 atTime:(CDStruct_1b6d18a9 *)arg3 didSnap:(char *)arg4;
