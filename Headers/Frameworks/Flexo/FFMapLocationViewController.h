...
@class LKSearchField, LKTableView, MapLocation, NSArrayController, NSMutableArray, NSPopover, NSString, NewKeywordTextField, NoClickTextField;

@interface FFMapLocationViewController : NSViewController <NSTableViewDataSource, NSPopoverDelegate>
{
    LKTableView *m_noneTableView;
    LKTableView *m_citiesTableView;
...
- (void)requestLocation:(id)arg1 anchoredToRect:(struct CGRect)arg2 inParentView:(id)arg3 allowNoLocation:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)mapLocationNearest:(struct CLLocationCoordinate2D)arg1;
