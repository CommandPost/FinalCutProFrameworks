...
#import <Flexo/FFInspectorEffectsRootDelegate-Protocol.h>

@class FFInspectorControllerHighlightDrawer, FFInspectorEffectsDraggingContext, NSArray, NSString;
@protocol FFInspectorEffectsBuildDelegate, FFInspectorEffectsDataSource, FFInspectorEffectsSubcontrollersDelegate;
