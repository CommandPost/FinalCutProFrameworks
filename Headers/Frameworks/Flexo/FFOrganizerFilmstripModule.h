...
@class FFAnalyzeMediaWindowController, FFKeywordEditor, FFModifyContentCreationDateWindowController, FFNumericEntry, FFOrganizerFilmListViewController, FFOrganizerFilmstripViewController, FFOrganizerZoomBezelSegmentedControl, FFRolesMenuController, FFShareHelper, FFTranscodeMediaWindowController, LKPopOverWindow, LKPopUpButton, LKSlider, LKTextField, NSArray, NSMenu, NSMenuItem, NSMutableArray, NSProButton, NSProThemeImageView, NSProView, OKPaneCapItemButton, OKPaneCapItemSlider, OKPaneCapItemView;
...
- (id)_topLevelClipRefsForClips:(id)arg1;
...
- (void)createCompoundClipSheetClosing:(int)arg1 sequence:(id)arg2 actionName:(id)arg3 project:(id)arg4 isCompoundClip:(BOOL)arg5;
