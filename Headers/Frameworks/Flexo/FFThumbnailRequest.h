...
@class CHChannelDouble, FFBackgroundTask, FFImage, FFMD5AndOffset, FFProject, FFRoleColorScheme, FFVideoProps, NSColor, NSMutableArray, NSMutableSet, NSString, NSValue;
...
- (id)initWithSkimmable:(id)arg1 imageTimeRange:(CDStruct_e83c9415)arg2 imageSize:(struct CGSize)arg3 imageQuality:(int)arg4 requestAudio:(BOOL)arg5 requestTimeType:(int)arg6 constrainedTimeRange:(CDStruct_e83c9415)arg7 highPriority:(BOOL)arg8 useImageCache:(BOOL)arg9 effectCount:(long long)arg10 audioOptions:(int)arg11 taskThatInitiatedRequest:(id)arg12;
