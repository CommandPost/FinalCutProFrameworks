...
@class FFShareInfoDataSource, FFShareInfoViewController, FFSharePanelRolesViewController, LKEmptyDFRController, LKImageView, LKSegmentedControl, NSLayoutConstraint, NSString, NSTabView, NSTrackingArea, NSView, NSViewController;
@protocol FFSharePanelAccessoryProtocol;
