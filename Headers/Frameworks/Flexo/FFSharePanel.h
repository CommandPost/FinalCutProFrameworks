...
@class CALayer, CKBatch, CKSource, FFShareDestination, FFShareDestinationController, FFShareInfoController, LKButton, LKImageView, LKSegmentedControl, NSArray, NSDictionary, NSImage, NSImageView, NSMutableDictionary, NSMutableSet, NSSet, NSString, NSTabView, NSTrackingArea, NSURL, NSView;

__attribute__((visibility("hidden")))
@interface FFSharePanel : NSWindowController <NSOpenSavePanelDelegate, NSTextFieldDelegate, NSTokenFieldDelegate, FFAutoexpandingTextFieldDelegate>
{
    CKSource *_source;
...
- (void)dealloc;
- (id)initWithSource:(id)arg1 destination:(id)arg2 error:(id *)arg3;
