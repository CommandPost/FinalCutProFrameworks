...
#import <Flexo/PCUserDefaultsBroadcastObserving-Protocol.h>

@class CALayer, FFMD5AndOffset, FFThumbnailRequest;
@protocol FFFilmstripCellDelegate, FFSkimmableProtocol><FFDataModelProtocol><FFAssetContainerProtocol;
...
- (id)description;
- (void)dealloc;
- (id)initWithSkimmable:(id)arg1 Frame:(struct CGRect)arg2 andTimeRange:(CDStruct_e83c9415)arg3 audioHeight:(double)arg4 requestTimeType:(int)arg5 filmStripTimeRange:(CDStruct_e83c9415)arg6 effectCount:(long long)arg7 filmstripMode:(int)arg8;
