...
@interface FFIMovieUpgrade : NSObject
{
    ...
    NSMapTable *_defaultFinalizedEvents;
...
+ (BOOL)linkDirectoryAtURL:(id)arg1 toURL:(id)arg2 error:(id *)arg3;
...
- (void)upgradeFinalizedMovieForProject:(id)arg1 inLibrary:(id)arg2;
- (id)defaultFinalizedEventForLibrary:(id)arg1 error:(id *)arg2;
...
- (id)thumbnailMD5ForSequence:(id)arg1 quality:(int)arg2;
- (void)dealloc;
