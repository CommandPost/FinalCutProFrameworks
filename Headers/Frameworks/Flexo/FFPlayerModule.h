...
@class CALayer, FFContext, FFPlayer, FFPlayerModuleDFRController, FFProvider, FFSourceAudio, FFSourceVideo, LKModuleLayout, NSDictionary, NSMutableArray, NSObject, NSString, NSTouchBar, NSView;
...
- (BOOL)_shouldLoadProviderForSkimmable:(id)arg1;
- (BOOL)_isEventProject:(id)arg1;
...
- (id)initWithSkimmable:(id)arg1 context:(id)arg2 effectCount:(long long)arg3 sublayoutName:(id)arg4;
- (id)initWithSkimmable:(id)arg1 context:(id)arg2 effectCount:(long long)arg3 sublayout:(id)arg4;
- (BOOL)loadView;
- (id)init;
