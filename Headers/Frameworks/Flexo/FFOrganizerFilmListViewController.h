...
@interface FFOrganizerFilmListViewController : FFOrganizerFilmstripViewController <FFOrganizerFilmstripViewDelegate, NSOutlineViewDelegate, NSOutlineViewDataSource, NSSplitViewDelegate>
{
    BOOL _needsData;
...
- (void)adjustAudioRoleCell:(id)arg1 forDataNode:(id)arg2;
...
- (int)mapAudioRolePopupIndexToAudioRoleEnum:(long long)arg1;
- (long long)mapAudioRoleEnumToAudioRolePopupIndex:(int)arg1;
