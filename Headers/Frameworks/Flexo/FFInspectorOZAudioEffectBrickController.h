...
@class FFAudioUnitEffect, FFInspectorEffectsControllerManager, FFInspectorRootViewController, PIBuildContext;

__attribute__((visibility("hidden")))
@interface FFInspectorOZAudioEffectBrickController : FFInspectorBridgeHostOZViewController <FFInspectorEffectsRootDelegate, FFInspectorEffectsDataSource>
{
