...
@class FFSnappingCalculation, NSSet;

@protocol FFSnappingDataSource <NSObject>
- (void)snappingCalc:(FFSnappingCalculation *)arg1 didSnapClips:(NSSet *)arg2 atTime:(CDStruct_1b6d18a9)arg3;
...
- (CDStruct_1b6d18a9)timePerPixelForSnappingCalc:(FFSnappingCalculation *)arg1;
