...
@protocol FFStoryline, FFStorylineClip, FFStorylineItem, TLKTimelineItem;

@interface FFAnchoredObject : FFBaseDSObject <TLKTimelineItem, FFInspectableObject, FFInspectorTabDataSource, FFInspectorToolDataSource, FFInspectorChannelDataSource, FFStorylineItem, NSSecureCoding, NSCopying, FFDataModelProtocol, FFSkimmableProtocol, FFAnchoredParentProtocol, FFMetadataProtocol, FFMD5Protocol, FFAssetContainerProtocol, FFEffectContainerProtocol, FFAnchoredSequenceDSObservedObject>
{
    ...
    _Atomic id _usedRangesMediaIdentifier;
}
...
- (void)revealInFinderWithProxy:(BOOL)arg1;
...
- (id)init;
- (id)type;
- (void)setLocalAnchorTime:(CDStruct_1b6d18a9)arg1;
- (CDStruct_1b6d18a9)localAnchorTime;
