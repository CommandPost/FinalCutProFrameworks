...
@class FFMetadataProxy, FFVideoProps, NSMapTable, NSMutableDictionary, NSMutableSet, NSSet, NSString;
...
@property(readonly, nonatomic) int audioRole;
- (id)validateAudioRole:(id)arg1;
- (void)setMetadataAudioRole:(id)arg1;
- (id)metadataAudioRole;
- (long long)multiCamAngle;
- (id)validateMultiCamAngle:(id)arg1;
- (void)setMetadataMultiCamAngle:(id)arg1;
- (id)metadataMultiCamAngle;
