...
@class FFVideoProps, NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSSet, NSString;
...
- (void)updateCachedNumPostAudioEffectsChannels:(unsigned int)arg1;
- (void)clearCachedNumPostAudioEffectsChannels;
