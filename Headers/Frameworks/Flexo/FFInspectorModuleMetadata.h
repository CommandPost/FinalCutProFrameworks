...
@class FFAsset, FFColouredView, FFInspectorMetadataContentRow, FFInspectorMetadataContentView, FFInspectorProjectEventsController, FFProFlippedView, LKButton, LKSegmentedControl, LKTextField, NSArrayController, NSMenu, NSMutableArray, NSMutableDictionary, NSPopUpButton, NSProImageView, NSProThemeImageView, NSScrollView, NSTextField, NSView, NSWindow;

__attribute__((visibility("hidden")))
@interface FFInspectorModuleMetadata : FFInspectorModule <NSMenuDelegate>
{
