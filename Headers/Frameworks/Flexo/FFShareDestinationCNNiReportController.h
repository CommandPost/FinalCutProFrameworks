...
@class LKButton, LKPopUpButton, NSButton, NSSecureTextField, NSString, NSTextField, NSWindow;

@interface FFShareDestinationCNNiReportController : FFShareDestinationWebController
{
    LKButton *_signInBtn;
