...
@class FFCHRootChannel, FFChannelChangeController, FFHeCropEffect, FFHeDistortEffect, FFHeMultiCamEffect, FFHeliumXFormEffect, FFRateConformVideoEffect, FFRetimingVideoEffect, FFRollingShutterEffect, FFStabilizationEffect, NSCursor, NSString, POOnScreenControl;
...
@interface FFProOSC : FFComponentOSC <POHostDelegate, POViewDelegate, POObjectDelegate>
{
    ...
    FFRollingShutterEffect *_rollingShutter;
    FFStabilizationEffect *_stabilization;
    FFRetimingVideoEffect *_retiming;
    FFRateConformVideoEffect *_rateConform;
...
- (id)findRollingShutterEffect:(id)arg1;
- (id)findStabilizationEffect:(id)arg1;
- (id)findRetimingEffect:(id)arg1;
- (id)findRateConformEffect:(id)arg1;
