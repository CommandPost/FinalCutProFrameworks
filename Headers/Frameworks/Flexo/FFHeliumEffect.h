...
-     // Error parsing type: ^{HGTransform=^^?I($_5260=[4][16f][16d])}24@0:8@16, name: createBaseTransformFromInversePixelTransform:
-     // Error parsing type: v32@0:8^{HGTransform=^^?I($_5260=[4][16f][16d])}16@24, name: convertHGTransformBackToPixelTransformSpace:pixelTransform:
-     // Error parsing type: ^{HGTransform=^^?I($_5260=[4][16f][16d])}24@0:8@16, name: newHGTransformFromPCMatrix44Double:
