...
#import <Flexo/FFAudioComponentsLayoutMapDelegate-Protocol.h>
#import <Flexo/FFSegmentedSourceProtocol-Protocol.h>
#import <Flexo/FFStoryline-Protocol.h>

@class FFAudioClipComponentsLayoutMap, FFCollectionFades, FFEffectStack, FFMD5AndOffset, FFVideoProps, FFVideoSegmenter, NSArray, NSDate, NSMutableArray, NSMutableDictionary, NSSet, NSString;
...
@interface FFAnchoredCollection : FFAnchoredObject <FFStoryline, FFSegmentedSourceProtocol, FFAudioComponentsLayoutMapDelegate>
{
    ...
    _Atomic double _cacheAudioSampleRate;
    _Atomic int _cacheAudioChannelCount;
    BOOL _audioComponentsLayoutMapNeedsLoadSync;
    _Atomic id _calculatedVideoProps;
    _Atomic id _roleCache;
    _Atomic id _contentCreated;
}
...
@property(retain, nonatomic) NSDate *contentCreated;
