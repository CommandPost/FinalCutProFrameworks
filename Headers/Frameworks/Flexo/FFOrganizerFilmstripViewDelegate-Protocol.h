...
@class FFAnchoredSequence, FFAnchoredTimeMarker, FFOrganizerFilmstripView, FigTimeRangeAndObject, LKViewModule, NSArray, NSDictionary, NSMenu, NSMenuItem, NSObject, NSPasteboard, NSString, NSTreeNode;
@protocol FFOrganizerMarkerEditorDelegate, FFOrganizerSkimmingDelegate;
