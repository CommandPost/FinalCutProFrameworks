...
@interface FFPlayerScheduledData : NSObject <HGRQJobProtocol, HGRQCustomJobProtocol>
{
    ...
    int _aaRepeats;
    _Atomic id _assignedDests;
    _Atomic id _assignedDestsSet;
    _Atomic id _skippedDests;
    ...
    CDStruct_c93a53e8 _scheduleTokenBlockedInfo;
    CDStruct_c93a53e8 _graphBuildBlockedInfo;
    CDStruct_c93a53e8 _graphExecBlockedInfo;
    ...
    struct atomic<NSError *> _errorInfo;
    struct atomic<bool> _inval;
    _Bool _liveGraphExecArtrace;
...
- (int)_getContextNumForFanoutJob:(id)arg1;
