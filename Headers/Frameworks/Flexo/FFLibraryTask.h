...
@class FFAssetCopyQueue, FFAssetTranscodeRequest, FFLibrary, FFLibraryDocument, FFLibraryTaskOptions, FFMediaIdentifierAliasMap, NSDictionary, NSMapTable, NSMutableArray, NSMutableSet, NSObject, NSString, NSURL;
@protocol FFMergeTaskDelegate;
