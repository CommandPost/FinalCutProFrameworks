...
@interface FFMediaEventProject : FFProject <FFXMLTranslationTarget, FFOrganizerItem, FFOrganizerMasterItem, FFOrganizerMasterItemDropTarget, FFOrganizerItemDraggingSource, NSSecureCoding>
{
    ...
    NSMutableSet *_persistentOwnedAssetMD5Strings;
...
@property BOOL isLoadingProjectData; // @synthesize isLoadingProjectData=_isLoadingProjectData;
...
- (id)_projectDataLoadIfNecessary;
- (id)_projectDataIfCached;
...
- (void)setPersistentOwnedAssetMD5Strings:(id)arg1;
- (id)persistentOwnedAssetMD5Strings;
- (void)_removeUndoOwnedAssetIdentifiersAndAssetMD5StringsObject:(id)arg1;
- (void)_addUndoOwnedAssetIdentifiersAndAssetMD5StringsObject:(id)arg1;
...
- (void)_removePersistentOwnedMediaIdentifiersObject:(id)arg1;
- (void)_addPersistentOwnedMediaIdentifiersObject:(id)arg1;
...
- (void)updateOldProjectToAddPersistentOwnedAssetMD5Strings;
- (void)_removeOwnedMediaIdentifiersAndAssetMD5StringsObject:(id)arg1;
...
- (BOOL)ownedMediaIdentifierOrAssetMD5StringIsInUndo:(id)arg1;
