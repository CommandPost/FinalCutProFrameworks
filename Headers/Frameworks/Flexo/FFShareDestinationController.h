...
@class FFShareDestination, FFSharePanelRolesViewController, LKButton, LKImageView, LKPopUpButton, LKTextField, NSArray, NSButton, NSPopUpButton, NSSet, NSStackView, NSString, NSTextField, NSView;
@protocol FFShareDestinationSettingsMenuDelegate;
...
@interface FFShareDestinationController : NSViewController
{
    ...
    NSButton *_exportSelectedLayerCheckbox;
...
@property(nonatomic) NSButton *exportSelectedLayerCheckbox; // @synthesize exportSelectedLayerCheckbox=_exportSelectedLayerCheckbox;
