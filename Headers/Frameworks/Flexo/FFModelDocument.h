...
#import <Flexo/DSStoreDelegateProtocol-Protocol.h>
#import <Flexo/FFModalDocumentSession-Protocol.h>
...
- (void)_registerUndoAction:(id)arg1;
- (void)_undoRedoAction:(id)arg1;
