...
- (id)getOZMLStyleFolderFromParent:(id)arg1;
...
- (void)applyTextTo:(id)arg1 fromString:(id)arg2;
- (void)setColor:(id)arg1 forSubchannelOf:(id)arg2 withID:(int)arg3;
- (void)familyIndex:(int *)arg1 styleIndex:(int *)arg2 forFont:(id)arg3;
- (void)applyAttributedString:(id)arg1 toTextFolder:(id)arg2;
- (void)applyTextAttributesTo:(id)arg1 fromAttributedString:(id)arg2;
