...
@class FFAnchoredCaption, FFCaptionEditorTextView, FFCaptionTextBlock, LKSegmentedControl, NSObject<FFCaptionTextBlockControllerDelegate>, NSString, NSUndoManager;
