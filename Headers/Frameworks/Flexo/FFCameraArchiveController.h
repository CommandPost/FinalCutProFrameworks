...
- (void)beginOptionsSheetForWindow:(id)arg1 volume:(id)arg2 initialStorageLocationURL:(id)arg3;
- (void)beginOptionsSheetForWindow:(id)arg1 source:(id)arg2 initialStorageLocationURL:(id)arg3;
