...
- (void)_checkAnalysisAvailableState:(id)arg1 context:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;
...
- (void)_ensureBackgroundJob:(id)arg1 sampleDur:(CDStruct_1b6d18a9)arg2 streamA:(id)arg3 streamB:(id)arg4 inputTimes:(struct PC_CMTimePair)arg5 downstreamPT:(id)arg6 forMD5:(CDStruct_bdcb2b0d)arg7;
- (void)_flowTransBG:(id)arg1 onTask:(id)arg2;
- (id)librariesInUse:(id)arg1;
- (id)assetsInUse:(id)arg1;
- (int)_generateFlowInfo:(id)arg1 sampleDur:(CDStruct_1b6d18a9)arg2 streamA:(id)arg3 timeA:(CDStruct_1b6d18a9)arg4 streamB:(id)arg5 timeB:(CDStruct_1b6d18a9)arg6 downstreamPT:(id)arg7 expectedMD5:(CDStruct_bdcb2b0d)arg8;
