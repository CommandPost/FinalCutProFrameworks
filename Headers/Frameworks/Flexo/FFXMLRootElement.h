...
+ (void)initialize;
+ (id)FFXMLRootElementWithContentsOfURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;
+ (id)FFXMLRootElementWithData:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;
