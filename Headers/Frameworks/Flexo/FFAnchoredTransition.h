...
- (id)newObjectExtendedSourceForTime:(CDStruct_1b6d18a9)arg1 offset:(CDStruct_1b6d18a9 *)arg2 range:(CDStruct_e83c9415 *)arg3 sourceid:(id)arg4 effectCount:(long long)arg5 clippedByContainer:(BOOL)arg6 unclippedRangeRequired:(CDStruct_e83c9415)arg7 anchoredObject:(id)arg8;
- (id)newObjectSourceForTimeWithExtender:(CDStruct_1b6d18a9)arg1 offset:(CDStruct_1b6d18a9 *)arg2 range:(CDStruct_e83c9415 *)arg3 identifier:(id *)arg4 effectCount:(long long)arg5 clippedByContainer:(BOOL)arg6 anchoredObject:(id)arg7;
...
- (CDStruct_1b6d18a9)transitionAmountFromLeft;
- (CDStruct_1b6d18a9)transitionAmountFromRight;
