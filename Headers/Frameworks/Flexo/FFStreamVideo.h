...
- (BOOL)md5AndOffsetForCGThumbnailAtTime:(CDStruct_1b6d18a9)arg1 temporalQuality:(int)arg2 md5:(CDStruct_60067b7e *)arg3 sampleOffset:(long long *)arg4 contentsScale:(double)arg5;
- (id)renderFormat;
