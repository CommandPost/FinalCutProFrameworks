...
@class LKButton, LKPopUpButton, NSButton, NSDictionary, NSMapTable, NSSecureTextField, NSString, NSTextField, NSWindow;

@interface FFShareDestinationYoukuController : FFShareDestinationWebController
{
    LKButton *_signInBtn;
