...
@interface FFImage : NSObject
{
    ...
    struct atomic<int> _errorCode;
}

+ (id)newStereoEquirect:(id)arg1 rightEye:(id)arg2 cameraMode:(int)arg3 downstreamPT:(id)arg4;
+ (id)newFrameAtLocation:(struct FxDevice *)arg1 withField1:(id)arg2 field2:(id)arg3 fieldDominance:(int)arg4 framePixelTransform:(id)arg5;
...
- (id)newFlattenedFFImageWithFormat:(id)arg1 locationOptions:(const struct FxDeviceSet *)arg2 flattenOptions:(CDStruct_f51ed29d *)arg3;
- (id)newFlattenedFFImageWithFormat:(id)arg1 location:(struct FxDevice *)arg2 flattenOptions:(CDStruct_f51ed29d *)arg3;
- (id)newFlattenedFFImageWithFormat:(id)arg1 locationOptions:(const struct FxDeviceSet *)arg2 flattenOptions:(CDStruct_f51ed29d *)arg3 roi:(struct CGRect)arg4 pixelTransform:(id)arg5 workingSpace:(int)arg6;
- (id)newFlattenedFFImageWithFormat:(id)arg1 location:(struct FxDevice *)arg2 flattenOptions:(CDStruct_f51ed29d *)arg3 roi:(struct CGRect)arg4 pixelTransform:(id)arg5 workingSpace:(int)arg6;
...
- (id)_mutableCopyDict;
- (id)newTextureBufferWithFormat:(id)arg1 location:(struct FxDevice *)arg2 roi:(struct CGRect)arg3 pixelTransform:(id)arg4 workingSpace:(int)arg5;
- (id)newTextureBufferWithFormatByFlatteningIfNeeded:(id)arg1 location:(struct FxDevice *)arg2 roi:(struct CGRect)arg3 pixelTransform:(id)arg4 flattenOptions:(CDStruct_f51ed29d *)arg5 workingSpace:(int)arg6;
- (id)newSimpleMtlTextureBufferInFormat:(id)arg1 device:(id)arg2;
- (id)newSimpleTextureBufferInFormat:(id)arg1 location:(struct FxDevice *)arg2;
...
- (id)newPixelBufferWithFormatByFlatteningIfNeeded:(id)arg1 roi:(struct CGRect)arg2 pixelTransform:(id)arg3 flattenOptions:(const CDStruct_f51ed29d *)arg4 workingSpace:(int)arg5;
...
- (struct CGImage *)newCGImageRefWithOptions:(id)arg1;
...
- (BOOL)isImageBackingCompatibleWithBackingRequest:(int)arg1 message:(id *)arg2;
- (id)newMtlTextureOnDevice:(id)arg1 withHoldToCompletionList:(id)arg2 requestFlags:(int)arg3 returnFlags:(int *)arg4;
...
- (id)initCacheNodeWithImage:(id)arg1 locationHint:(struct FFImageLocationHint)arg2 cacheMode:(unsigned int)arg3 md5:(CDStruct_bdcb2b0d)arg4 offset:(long long)arg5 cacheFmt:(id)arg6;
...
- (id)initWithCVImageBuffer:(struct __CVBuffer *)arg1 pixelFormat:(id)arg2 colorSpace:(struct CGColorSpace *)arg3 pixelTransform:(id)arg4 field:(unsigned int)arg5 sourceColorConformer:(id)arg6 sourceColorConformTargetColorSpace:(int)arg7;
...
- (id)initWithCVImageBuffer:(struct __CVBuffer *)arg1 origin:(struct CGPoint)arg2 pixelTransform:(id)arg3 field:(unsigned int)arg4 overrideAlphaInfo:(int)arg5 disable422Filtering:(BOOL)arg6 sourceColorConformer:(id)arg7 sourceColorConformTargetColorSpace:(int)arg8;
- (id)initWithCVImageBuffer:(struct __CVBuffer *)arg1 origin:(struct CGPoint)arg2 pixelTransform:(id)arg3 field:(unsigned int)arg4 overrideAlphaInfo:(int)arg5 sourceColorConformer:(id)arg6 sourceColorConformTargetColorSpace:(int)arg7;
