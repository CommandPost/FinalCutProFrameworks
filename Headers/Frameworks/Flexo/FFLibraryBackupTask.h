...
#import <Flexo/NSFileManagerDelegate-Protocol.h>
#import <Flexo/NSOpenSavePanelDelegate-Protocol.h>

@class FFBackgroundTask, FFLibraryDocument, NSDateFormatter, NSDictionary, NSError, NSString, NSURL;
