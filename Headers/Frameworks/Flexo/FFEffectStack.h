...
@interface FFEffectStack : FFBaseDSObject <NSSecureCoding, NSCopying, FFCHChannelDelegate, FFDataModelProtocol, FFMD5Protocol, FFAnchoredSequenceDSObservedObject>
{
    ...
    struct atomic<unsigned int> _noOpIntrinsicFlags;
}
...
+ (id)_intrinsicEffectIDsBeforeUserEffects;
+ (BOOL)supportsConstantRetiming:(id)arg1;
+ (BOOL)supportsVideoRateConform:(id)arg1;
+ (BOOL)requiresVideoRateConform:(id)arg1 videoProps:(id)arg2;
+ (void)updateLegacyAudioIntrinsicChannelsEffectStack:(id)arg1;
+ (BOOL)storesCollapsedStateForAudioChannelID:(unsigned int)arg1;
+ (unsigned long long)audioEffectCountForObject:(id)arg1;
+ (id)roleDisplayNameForEffectStack:(id)arg1 andObject:(id)arg2 outRole:(id *)arg3;
+ (void)setScopeFadeOutLength:(CDStruct_1b6d18a9)arg1 fadeType:(int)arg2 forObject:(id)arg3;
+ (void)setScopeFadeOutLength:(CDStruct_1b6d18a9)arg1 forObject:(id)arg2;
+ (int)scopeFadeOutTypeForObject:(id)arg1;
+ (CDStruct_1b6d18a9)scopeFadeOutLengthForObject:(id)arg1;
+ (void)getScopeFadeOutLength:(CDStruct_1b6d18a9 *)arg1 fadeType:(int *)arg2 forObject:(id)arg3;
+ (void)setScopeFadeInLength:(CDStruct_1b6d18a9)arg1 fadeType:(int)arg2 forObject:(id)arg3;
+ (void)setScopeFadeInLength:(CDStruct_1b6d18a9)arg1 forObject:(id)arg2;
+ (int)scopeFadeInTypeForObject:(id)arg1;
+ (CDStruct_1b6d18a9)scopeFadeInLengthForObject:(id)arg1;
+ (void)getScopeFadeInLength:(CDStruct_1b6d18a9 *)arg1 fadeType:(int *)arg2 forObject:(id)arg3;
+ (void)resetAudioEffects:(unsigned int)arg1 forObject:(id)arg2;
+ (id)inspectorAudioEnhancementsChannel;
+ (id)inspectorAudioPanChannel;
+ (BOOL)supportsUserAudioEffect:(id)arg1 forEffectStack:(id)arg2;
+ (BOOL)removeAudioEnhancementsForEffectStack:(id)arg1;
+ (BOOL)canResetAudioEnhancementsForEffectStack:(id)arg1;
+ (BOOL)resetAudioEnhancementsForEffectStack:(id)arg1;
+ (BOOL)resetAudioAnalysisForEffectStack:(id)arg1;
+ (void)resetAudioEqualizationForEffectStack:(id)arg1;
+ (BOOL)isAudioEnhancementEffectID:(id)arg1;
...
- (id)storeForUndo;
- (id)modelDocument;
- (void)aboutToModifyEffectStack;
- (void)clearPlaceholderEffectStackState;
- (void)_resetPlaceholderEffectStackBlock:(CDUnknownBlockType)arg1;
- (id)initAsPlaceholderEffectStack:(id)arg1 willModifyBlock:(CDUnknownBlockType)arg2;
...
- (id)intrinsicColorConformEffect;
...
- (void)addIntrinsicColorConformEffectIfRequired;
- (id)newTransientCompositeEffectNode;
...
- (void)resetIntrinsicsWithIDs:(id)arg1;
- (void)resetIntrinsics:(id)arg1;
- (void)resetIntrinsicEffectID:(id)arg1;
- (void)removeAllEffects;
- (void)removeEffectsWithEffectIDs:(id)arg1;
...
- (void)insertDefaultIntrinsicEffect:(id)arg1 atIndex:(unsigned long long)arg2;
...
- (void)removeIntrinsicEffectAtIndex:(unsigned long long)arg1;
- (void)insertIntrinsicEffect:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)_removeIntrinsicEffectAtIndex:(unsigned long long)arg1;
- (void)_insertIntrinsicEffect:(id)arg1 atIndex:(unsigned long long)arg2 postNotification:(BOOL)arg3 reason:(int)arg4;
...
- (void)_insertEffect:(id)arg1 atIndex:(unsigned long long)arg2 postNotification:(BOOL)arg3 updateHasObjectReferenceAndNonIntrinsicEffects:(BOOL)arg4 reason:(int)arg5;
...
- (BOOL)effectRemoveHoldPresetAtComponentTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9 *)arg2 error:(id *)arg3;
- (int)effectApplyHoldPresetAtComponentTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9)arg2 error:(id *)arg3;
...
- (void)performHighQualityRetimeOpticalFlowWithSource:(id)arg1 md5:(CDStruct_bdcb2b0d)arg2 segmentStoreRef:(id)arg3 renderInfo:(id)arg4 uponCompletion:(id)arg5;
...
- (id)inspectorAudioVolumeChannel;
- (void)releaseAudioProjectFadesChannel;
- (id)demandAudioProjectFadesChannel;
- (id)audioProjectFadesChannel;
...
- (void)addAudioIntrinsicChannels;
- (BOOL)hasNonIntrinsicAudioEffects;
- (BOOL)hasAudioRetimingEffects;
