...
@class FFDestVideoRequestInfo, FFMovieWriter, NSArray, NSDictionary, NSError, NSMutableArray, NSObject, NSString;
...
@interface FFDestQTExporter : FFDestRenderer
{
    ...
    double _proxyImageToPixelWidthScale;
    double _proxyImageToPixelHeightScale;
}

@property(nonatomic) double proxyImageToPixelHeightScale; // @synthesize proxyImageToPixelHeightScale=_proxyImageToPixelHeightScale;
@property(nonatomic) double proxyImageToPixelWidthScale; // @synthesize proxyImageToPixelWidthScale=_proxyImageToPixelWidthScale;
