...
@class CALayer, FFFilmstripSelectionLayer, FFNUpDisplay, FFRetimeEditorSelection, FFRetimingEffect, FFSpeedLayer, NSImage, NSMutableArray, NSProThemeFacet, NSString, TLKItemLayer;
