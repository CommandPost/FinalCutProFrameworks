...
#import <Flexo/FFOutlineViewDataSource-Protocol.h>
#import <Flexo/FFOutlineViewDelegate-Protocol.h>

@class FFOrganizerMasterItemNode, FFOutlineView, LKTableView, NSArray, NSIndexPath, NSMapTable, NSMutableArray, NSObject, NSString, NSTextField;
...
- (void)reloadOutlineViewNowWithSidebarProvider:(id)arg1;
...
- (id)createTreeNodeForModelObject:(id)arg1 collapsedIdentifiers:(id)arg2;
- (void)didChangeSidebarProvider;
- (void)willChangeSidebarProvider:(id)arg1;
