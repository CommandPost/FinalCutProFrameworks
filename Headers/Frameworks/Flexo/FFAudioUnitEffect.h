...
+ (void)updateToEffectState:(struct NSDictionary *)arg1 forInProcessEffect:(id)arg2;
+ (void)initialize;
...
- (id)requestSlaveUnitForClient:(void *)arg1 forPlayback:(BOOL)arg2 numChannels:(unsigned int)arg3 sampleRate:(double)arg4 effectState:(struct NSDictionary *)arg5;
...
- (void)updateToEffectState:(struct NSDictionary *)arg1 usingMasterUnit:(id)arg2;
- (struct NSDictionary *)currentEffectState;
- (int)presetID;
- (void)setPresetWithID:(int)arg1;
- (void)resetToCurrentPreset;
- (void)resetToDefaultPreset;
- (void)setAudioUnitEffectStateAsPreset:(struct NSDictionary *)arg1;
- (id)defaultPreset;
- (id)preset;
