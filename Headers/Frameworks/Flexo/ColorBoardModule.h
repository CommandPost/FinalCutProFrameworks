...
@class ColorBoardModuleView, LKButton, LKPaneCapSegmentedControl, LKSegmentedControl, LKTextField, NSProView, NSProWindow;
...
@interface ColorBoardModule : LKViewModule
{
    ...
    ColorBoardModuleView *_colorBoardView;
...
@property(retain, nonatomic) ColorBoardModuleView *colorBoardView; // @synthesize colorBoardView=_colorBoardView;
