...
+ (id)filmstripWithSkimmable:(struct NSObject *)arg1 andRange:(CDStruct_e83c9415)arg2 timeRange:(CDStruct_e83c9415)arg3 thumbHeight:(double)arg4 audioHeight:(double)arg5 forEditing:(BOOL)arg6 clippedRange:(CDStruct_e83c9415)arg7 clippedWidth:(double)arg8 thumbCount:(double)arg9 maxThumbWidth:(double)arg10 cellDuration:(CDStruct_1b6d18a9)arg11 squareThumbs:(BOOL)arg12 singleFilmstripMode:(BOOL)arg13;
...
- (void)releaseLayer;
- (void)updateIfNeeded;
- (id)initWithSkimmable:(struct NSObject *)arg1 andRange:(CDStruct_e83c9415)arg2 timeRange:(CDStruct_e83c9415)arg3 thumbHeight:(double)arg4 audioHeight:(double)arg5 forEditing:(BOOL)arg6 clippedRange:(CDStruct_e83c9415)arg7 clippedWidth:(double)arg8 thumbCount:(double)arg9 maxThumbWidth:(double)arg10 cellDuration:(CDStruct_1b6d18a9)arg11 squareThumbs:(BOOL)arg12 singleFilmstripMode:(BOOL)arg13;
