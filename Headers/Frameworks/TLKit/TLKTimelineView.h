...
#import <TLKit/TLKEventDispatcherView-Protocol.h>
...
@protocol TLKTimelineItem, TLKTimelineViewDataSource, TLKTimelineViewDelegate, TLKVisibleRectNotifying;
...
@interface TLKTimelineView : NSView <TLKEventDispatcherView, CALayerDelegate>
{
    ...
    NSMapTable *_selectNextCache;
    NSMapTable *_selectPreviousCache;
