...
@interface TLKTimelineView : NSView <TLKEventDispatcherView, TLKTimelineScrollViewDataSource>
{
    ...
    struct {
        ...
        unsigned int keepPlayheadFixed:1;
    ...
    struct {
        ...
        unsigned int respondsToAdjustSkimmingTime:1;
        unsigned int respondsToPrecisionEditorWillSkimItem:1;
    ...
    struct {
        ...
        unsigned int respondsToShouldSplitItemSnapped:1;
        unsigned int respondsToShouldSelectRangeAtTime:1;
...
- (BOOL)shouldTrimEdge:(id)arg1 trimType:(int)arg2 edgeType:(int)arg3 ofItems:(id)arg4 byTimeOffset:(CDStruct_1b6d18a9 *)arg5;
- (void)trimEdge:(id)arg1 trimType:(int)arg2 edgeType:(int)arg3 ofItems:(id)arg4 byTimeOffset:(CDStruct_1b6d18a9 *)arg5;
...
- (BOOL)shouldSplitItem:(id)arg1 atTime:(CDStruct_1b6d18a9 *)arg2 snapped:(char *)arg3;
- (void)splitItem:(id)arg1 atTime:(CDStruct_1b6d18a9)arg2;
- (BOOL)shouldSelectRangeAtTime:(CDStruct_1b6d18a9 *)arg1 snapped:(char *)arg2;
...
- (void)notifyWillTrimEdge:(id)arg1 trimType:(int)arg2 edgeType:(int)arg3 ofItems:(id)arg4;
...
- (double)_averageCellWidth;
@property double timePerPixel;
- (void)_updateAfterTimePerPixelChanges;
...
- (CDStruct_1b6d18a9)_adjustSkimmingTime:(CDStruct_1b6d18a9)arg1 forItem:(id)arg2 snapped:(BOOL)arg3;
- (void)_precisionEditorWillSkimItem:(id)arg1 atTime:(CDStruct_1b6d18a9 *)arg2 didSnap:(char *)arg3;
