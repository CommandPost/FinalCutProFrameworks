...
- (BOOL)shouldNegateTrimOffset:(id)arg1;
...
@property(nonatomic) NSString *draggedPart; // @synthesize draggedPart=_draggedPart;
@property(nonatomic) TLKItemLayer *clickedLayer; // @synthesize clickedLayer=_clickedLayer;
@property(retain, nonatomic) id <TLKTimelineItem> draggedItem; // @synthesize draggedItem=_draggedItem;
