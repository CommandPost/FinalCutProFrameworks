...
@class NSArray, TLKItemComponentFragment, TLKItemLaneInfo, TLKLayoutManager, TLKLayoutTile;

@protocol TLKLayoutManagerDelegate <NSObject>

@optional
- (double)layoutManager:(TLKLayoutManager *)arg1 minimumHeightForLaneInfo:(TLKItemLaneInfo *)arg2;
