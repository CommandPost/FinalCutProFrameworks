...
@property(nonatomic) NSMutableDictionary *changesByTable; // @synthesize changesByTable=_changesByTable;
@property(nonatomic) NSMutableArray *changeLogRecords; // @synthesize changeLogRecords=_changeLogRecords;
