...
+ (id)matrixWithSIMDDouble4x4:(CDStruct_f1db2b5e)arg1;
+ (id)matrixWithSIMDFloat4x4:(CDStruct_f1db2b5e)arg1;
...
- (void)makeIdentity;
- (BOOL)isIdentity;
@property(nonatomic) CDStruct_f1db2b5e SIMDDouble4x4;
@property(nonatomic) CDStruct_f1db2b5e SIMDFloat4x4;
- (id)array;
...
- (id)initWithSIMDDouble4x4:(CDStruct_f1db2b5e)arg1;
- (id)initWithSIMDFloat4x4:(CDStruct_f1db2b5e)arg1;
