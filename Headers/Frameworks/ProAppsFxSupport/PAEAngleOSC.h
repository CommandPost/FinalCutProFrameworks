...
- (PCVector2_79efa81a)objectAbsoluteKnobCenterForPoint:(const PCVector2_79efa81a *)arg1 atTime:(double)arg2;
- (PCVector2_79efa81a)drawingSpaceKnobClickForPoint:(const PCVector2_79efa81a *)arg1 atTime:(double)arg2;
...
- (PCVector2_79efa81a)objectAbsoluteKnobAtTime:(double)arg1;
- (PCVector2_79efa81a)objectNormalizedKnobAtTime:(double)arg1;
- (void)_calculateScreenSpaceInputCenter:(PCVector2_79efa81a *)arg1 segmentKnobCenter:(PCVector2_79efa81a *)arg2 segmentLength:(double *)arg3 withParamAPI:(id)arg4 andOSCAPI:(id)arg5 atTime:(double)arg6;
- (void)_setTextureOrigins;
- (PCRect_3a266109)objectBounds;
- (PCVector2_79efa81a)getRodDirectionAtTime:(double)arg1;
- (double)getRodLengthAtTime:(double)arg1;
- (double)getRodAngleAtTime:(double)arg1;
- (double)getVariableRadiusLengthAtTime:(double)arg1 withPosition:(const PCVector2_79efa81a *)arg2;
- (double)knobRadius;
- (void)setDiscAngle:(double)arg1;
- (void)setAngleDelegate:(id)arg1;
- (void)setAngle:(double)arg1 atTime:(double)arg2;
- (float)angleAtTime:(double)arg1;
- (PCVector2_79efa81a)objectAbsoluteCenterAtTime:(double)arg1;
- (PCVector2_79efa81a)objectNormalizedCenterAtTime:(double)arg1;
