...
- (void)_calculateCenter:(PCVector2_79efa81a *)arg1 innerRadius:(PCVector2_79efa81a *)arg2 outerRadius:(PCVector2_79efa81a *)arg3 withParamAPI:(id)arg4 andOSCAPI:(id)arg5 atTime:(double)arg6;
- (id)delegate;
