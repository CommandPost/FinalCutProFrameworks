...
- (BOOL)isEndGap;
- (BOOL)isFrontGap;
- (BOOL)canThrowRenderOutput:(id)arg1 withInputA:(id)arg2 withInputB:(id)arg3 withTimeFraction:(float)arg4 withSpeed:(float)arg5 withInfo:(CDStruct_8b442eb9)arg6;
- (BOOL)canThrowRenderOutput:(id)arg1 withInputA:(id)arg2 withInputB:(id)arg3 withTimeFraction:(float)arg4 withInfo:(CDStruct_8b442eb9)arg5;
- (BOOL)renderOutput:(id)arg1 withInputA:(id)arg2 withInputB:(id)arg3 withTimeFraction:(float)arg4 withInfo:(CDStruct_8b442eb9)arg5;
- (double)relativeShutterAtTime:(double)arg1;
- (BOOL)getEaseIn:(double *)arg1 easeOut:(double *)arg2 atTime:(double)arg3;
- (BOOL)convertTimeFraction:(double)arg1 toLocal:(double *)arg2 andDerivative:(double *)arg3 atTime:(double)arg4;
