...
- (void)abortRender;
- (_Bool)renderScene:(struct OZDocument *)arg1 cacheDisplayManager:(id)arg2 startTime:(const CDStruct_1b6d18a9 *)arg3 endTime:(const CDStruct_1b6d18a9 *)arg4 workingGPUs:(const vector_7dcc6df9 *)arg5;
