...
- (BOOL)performDrop:(struct OZPasteList *)arg1 dropInfo:(struct OZDropTargetInfo *)arg2 undoDescription:(struct PCString *)arg3 pasteOnlyDependents:(BOOL)arg4 idReMap:(map_30220020 *)arg5 addedObjects:(vector_6d1252f3 *)arg6 dropCompletionBlock:(CDUnknownBlockType)arg7;
