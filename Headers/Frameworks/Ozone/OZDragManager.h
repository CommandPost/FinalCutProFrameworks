...
+ (void)copyObjectsReferencedBy:(unsigned int)arg1 inScene:(struct OZScene *)arg2 toPasteList:(struct OZPasteList *)arg3 copiedIDs:(vector_12da65de *)arg4;
+ (id)dragManager;
...
- (void)performReplace:(struct OZSceneNodeFile *)arg1 dropInfo:(struct OZDropTargetInfo *)arg2;
- (struct OZSceneNode *)performSplit:(struct OZSceneNodeFile *)arg1 footageExtent:(struct PCTimeRange)arg2 withOffset:(const CDStruct_1b6d18a9 *)arg3 andDuration:(const CDStruct_1b6d18a9 *)arg4 target:(struct OZSceneNode *)arg5 document:(struct OZDocument *)arg6;
