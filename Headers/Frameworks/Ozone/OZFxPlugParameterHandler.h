...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)transactionForParameterID:(unsigned int)arg1 atTime:(CDStruct_1b6d18a9)arg2 transactionID:(unsigned long long)arg3;
- (BOOL)hasPathParameters;
- (void)setupImageParamIDs:(void *)arg1;
- (id)getAllParameterValuesAtTime:(CDStruct_1b6d18a9)arg1 transactionID:(unsigned long long)arg2;
