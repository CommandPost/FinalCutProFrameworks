...
-     // Error parsing type: r^{OZSceneSettings=^^?iiIBIdBd{AtomicWorkingGamut={atomic<PCWorkingGamutValue>=Ai}}iii{PCColor={ColorComponents=i[5d]}{PCColorSpaceHandle=^{CGColorSpace}}}iBIIdBBdi{PCString=^{__CFString}}IIdIIIBfiBiBiiBi}16@0:8, name: sceneSettings
