...
#import <Ozone/OZViewCtlrDelegate-Protocol.h>

@interface OZMoViewCtlrDelegate : NSObject <OZViewCtlrDelegate>
{
    struct OZScene *_pScene;
    BOOL _isHUD;
    BOOL _suppressWillDidChange;
}

+ (struct OZDocument *)documentFromCtlr:(id)arg1;
