...
@class LKCursor, NSArray, NSMenu, NSMutableArray, NSTrackingArea, OZViewerSnaps, POMetalOSCHelper, POOnScreenControl;
...
@interface OZViewerOSC : OZViewerBase <NSTextInputClient>
{
    ...
    POMetalOSCHelper *_metalHelper;
}

@property(readonly, nonatomic) POMetalOSCHelper *metalHelper; // @synthesize metalHelper=_metalHelper;
