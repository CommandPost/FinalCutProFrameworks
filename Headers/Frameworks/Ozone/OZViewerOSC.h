...
#import <Ozone/OZViewerBase.h>

#import <Ozone/NSTextInputClient-Protocol.h>

@class LKCursor, NSArray, NSMenu, NSMutableArray, NSTrackingArea, OZViewerRenderController, OZViewerSnaps, POOnScreenControl;

@interface OZViewerOSC : OZViewerBase <NSTextInputClient>
{
    ...
    OZViewerRenderController *_renderController;
}

@property(readonly, nonatomic) OZViewerRenderController *renderController; // @synthesize renderController=_renderController;
...
- (BOOL)checkEffectsThatNeedOSCsIn360GroupsAndAdd:(BOOL)arg1;
- (BOOL)checkEffectsThatNeedOSCsIn360GroupsWithNode:(struct OZSceneNode *)arg1 andAdd:(BOOL)arg2;
...
- (void)checkStates;
- (void)bindOutputBufferInGL;
- (void)clearOSCCursor;
- (void)setCursor:(id)arg1;
- (void)setCursorForOSC:(id)arg1 event:(id)arg2;
- (void)resetCursorRects;
- (void)drawCameraOptionsOSC;
- (void)drawDragAndDrop:(const PCMatrix44Tmpl_e98c85ee *)arg1;
- (void)drawTool;
- (void)drawOnScreenControls;
- (void)drawControl:(id)arg1;
