...
@class MDPMultiline, MDPScreenspaceQuad, NSImage, NSString, NSTimer;

@interface OZEditTool : OZTool <OZRenderClient, POOnScreenControlMetalRendering>
{
    _Bool _setUndo;
    _Bool _cloned;
    int _moving;
