...
@class NSArray, NSCursor, NSDictionary, NSEvent, NSMutableArray, NSMutableDictionary, NSMutableString, NSTrackingArea, NSView, TLKEventContext, TLKEventHandler, TLKPartArray, TLKToolTipManager;
