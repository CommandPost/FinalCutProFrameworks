...
@class LKSlidingAnimation, NSMutableArray, NSMutableIndexSet, NSScrollView, NSSet, NSString, NSViewAnimation;

@interface LKTileView : NSView <NSCoding, NSAnimationDelegate>
{
    double _intertileHeight;
    double _intertileWidth;
    ...
    LKSlidingAnimation *_slidingAnimation;
...
@property(nonatomic) double intertileWidth; // @synthesize intertileWidth=_intertileWidth;
@property(nonatomic) double intertileHeight; // @synthesize intertileHeight=_intertileHeight;
