...
@class LKTearOffTabView, NSTabView, NSTabViewItem, NSWindow;

@protocol LKTearOffTabViewDelegate <NSTabViewDelegate>
...
- (LKTearOffTabView *)tabView:(NSTabView *)arg1 startDraggingTabViewItem:(NSTabViewItem *)arg2;
