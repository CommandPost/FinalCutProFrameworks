...
- (void)hideSubmoduleWithIdentifier:(id)arg1 revealStyle:(unsigned long long)arg2;
- (void)hideSubmoduleWithIdentifier:(id)arg1;
- (void)showSubmoduleWithIdentifier:(id)arg1 revealStyle:(unsigned long long)arg2;
...
- (void)moveSubmoduleWithIdentififier:(id)arg1 before:(BOOL)arg2 siblingModuleWithIdentififier:(id)arg3;
