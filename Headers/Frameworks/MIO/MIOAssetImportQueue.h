...
#import <MIO/MIOAssetImportTrackMediatorDelegate-Protocol.h>

@class AVAssetReader, AVAssetWriter, MIOAssetImportRequest, MIOAssetImportTrackMediator, NSArray, NSMutableArray, NSString;
@protocol MIOAssetImportQueueDelegate, OS_dispatch_queue, OS_dispatch_semaphore;
