...
@property(readonly) NSArray *outputFrameRates; // @synthesize outputFrameRates=mOutputFrameRates;
@property(readonly) NSArray *inputFrameRates; // @synthesize inputFrameRates=mInputFrameRates;
@property(retain) NSString *currentInputFormat;
- (struct opaqueCMFormatDescription *)currentInputFormatDescription;
@property(readonly) NSArray *inputFormats; // @synthesize inputFormats=mInputFormats;
- (id)availableFormats;
